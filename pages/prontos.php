<?php
// pages/prontos.php - Pedidos prontos
$page_title = 'Pedidos Prontos';
...
$current_url = htmlspecialchars($_SERVER['REQUEST_URI'] ?? 'pedidos_central.php?aba=prontos');
