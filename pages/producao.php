<?php
// pages/producao.php - Pedidos em produÃ§Ã£o
$page_title = 'Pedidos em Produção';
...
$current_url = htmlspecialchars($_SERVER['REQUEST_URI'] ?? 'pedidos_central.php?aba=producao');
